...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style10">Fragment and Upload Data !!! </h2>
          
          <div class="clr"></div>
          <div class="img"></div>
          <div class="post_content">
            
            <form id="form1" name="form1" method="post" action="DDUploadBlocks1.jsp">
          <table width="598" border="1" align="center">
            <tr>
              <td width="286" bgcolor="#FF0000"><span class="style11">Select File :- </span></td>
              <td width="356"><input required="required" type="file" name="t42" id="file"  onchange="loadFileAsText()" /></td>
            </tr>
            <tr>
              <td bgcolor="#FF0000" class="style11">File Name :- </td>
              <td><input required="required" name="tt" type="text" id="t42" size="50"/></td>
            </tr>
            <tr>
              <td bgcolor="#FF0000"><span class="style11"></span></td>
              <td><textarea name="text" id="textarea" cols="50" rows="15"></textarea></td>
            </tr>
            <tr>
              <td bgcolor="#FF0000"><span class="style11">MAC1 :- </span></td>
              <td><input name="t4" type="text" id="t4" size="50" value="" readonly="readonly" /></td>
            </tr>
			<tr>
              <td bgcolor="#FF0000"><span class="style11">MAC2 :- </span></td>
              <td><input name="t4" type="text" id="t4" size="50" value="" readonly="readonly" /></td>
            </tr>
			<tr>
              <td bgcolor="#FF0000"><span class="style11">MAC3 :- </span></td>
              <td><input name="t4" type="text" id="t4" size="50" value="" readonly="readonly" /></td>
            </tr>
			<tr>
              <td bgcolor="#FF0000"><span class="style11">MAC4 :- </span></td>
              <td><input name="t4" type="text" id="t4" size="50" value="" readonly="readonly" /></td>
            </tr>
            ...
            <tr>
              ...
              <td><input type="submit" name="Submit" value="Encrypt and Check Data Replication" /></td>
            </tr>
          </table>
  </form>
          </div>
