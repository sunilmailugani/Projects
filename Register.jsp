					...
					if ( rs1.next() )
					   {
							...
							%>
							<p><a href="O_Register.html">Back</a>         <a href="index.html">Home</a> </p>
					   ...
					   {
						PreparedStatement ps=connection.prepareStatement("insert into owner(name,pass,email,mobile,addr,dob,gender,pin,location,imagess) values(?,?,?,?,?,?,?,?,?,?)");
