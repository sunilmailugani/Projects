...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Confirm Upload Fragments !!! </h2>
...
%>
 <div class="clr"></div>
          ...
          <form action="OUploadBlocks2.jsp" method="post">
<table width="598" border="1" align="center">
	...
	<tr>
		<td width="286" bgcolor="#FF0000"><span class="style13">Fragment-3 </span></td>
	...
	<tr>
		<td bgcolor="#FF0000"><span class="style13">MAC-4: </span></td>
