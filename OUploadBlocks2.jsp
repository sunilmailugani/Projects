...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Confirm Upload Data Fragments </h2>
...
%>
	...
	<h2>	<% out.println("Client Side Data Replication Found !!! Pls try some other File");  
	
	Statement st211 = connection.createStatement();
						st211.executeUpdate("insert into  deduplication(fname,ownername,cname,ct1,mac1,ct2,mac2,ct3,mac3,ct4,mac4,sk,dt) values ('"
										+ file
										+ "','"
										+ owner
										+ "','"
		...
		Statement st21 = connection.createStatement();
						st21.executeUpdate("insert into  cloudserver(fname,ownername,cname,ct1,mac1,ct2,mac2,ct3,mac3,ct4,mac4,sk,dt) values ('"
										...
										Statement st211 = connection.createStatement();
						st211.executeUpdate("insert into  OwnerFiles(fname,ownername,cname,ct1,mac1,ct2,mac2,ct3,mac3,ct4,mac4,sk,dt) values ('"
										+ file
										+ "','"
										+ owner
										+ "','"
...
<h2>Data Fragments Uploaded Successfully !!!</h2>
